...
function adduser(data){
    ...
    var html='    <div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html+='<div class="bottom jiurenniuniu-bottom"style="margin-top:-4px; height:4.2vh;">'
     html+='<div class="bname jiurenniuniu-bname"style="color:#fff;font-size:12px;">'+decode64(data.user.nickname)+'</div>'
    html+='<div class="bscore jiurenniuniu-bname"style="color:#ff9000;font-size:14px;">'+data.user.dqjf+'</div></div> '
    html+='<img id="banker213612" src="/app/img/bull9/bull_banker_bg.png" class="background jiurenniuniu-background" /> '
     ...
     html+='<div id="bankerAnimate1'+indexuser+'" class="jiurenniuniu-background2 flash" style="border-radius:2vw;"></div><div class="isReady" style="-webkit-text-stroke:1px #000;text-stroke:1px #000;display:none">准备</div></div>';
     $('#member').append(html);
     if(data.user.zt==1){
...
function overroom(data){
    ...
    var detailedBtn = '<a class="search-number-box-btn" href="/portal/home/xiangqing/room/'+window.roomID+'" style="position: absolute;z-index: 9999999;display: block;"></a>';
...
function operationButton(data){
    ...
    if(data=='3'){
        ...
        html+='                      <img class="operationButton-3" src="/app/img/bull10/niuniu-zhuang.png">'
        html+='                      <div class="operationButton-3-ts" style="color:#ffe419;">'
        html+='                       抢庄'
        html+='                      </div>'
        html+='                     </div>'
        html+='                     <div class="operationButton-4-zt" id="jiurenbqz" style="display: inline-block;margin: 0 2%;" onclick="qbank(0,2)">'
        html+='                      <img class="operationButton-gg" src="/app/img/bull10/niuniu-zhuang1.png">'
        html+='                      <div class="operationButton-gg1" style="color:#ffe419;">'
        html+='                       不抢'
        html+='                      </div>'
        html+='                     </div>';
    }
    ...
    if(data=='6'){
        html+='<div class="gongg" style="display: block;-webkit-text-stroke:1px #000;text-stroke:1px #000;">点击牌面看牌</div>';
    }
    if(data=='7'){
