...
var Page = {
    ...
    load: function() {
        ...
        if (1) {
            Page.code = location.href.split('?id=')[1].split('&')[0];
            $.get('/portal/dasheng/roomrecord', {
                    id: Page.code
                },
                function(d) {
                    var card_rule = '',
                    ...
                    if (parseInt(d.status) === 1) {
                        $('.scoreboard').touch(function() {
                            location.href = '/portal/index/dashengroom.html?room='+Page.code;
                            return;
                            if (parseInt(d.info.room.game) === 1) {
                                if (win.app > 0) {
                                    Page.appRanking('sixoxen.html?code=' + Page.code);
                                } else {
                                    location.href = 'sixoxen.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 2) {
                                if (win.app > 0) {
                                    Page.appRanking('goldFlower.html?code=' + Page.code);
                                } else {
                                    location.href = 'goldFlower.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 3) {
                                if (win.app > 0) {
                                    Page.appRanking('thirteen.html?code=' + Page.code);
                                } else {
                                    location.href = 'thirteen.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 4) {
                                if (win.app > 0) {
                                    Page.appRanking('tenoxen.html?code=' + Page.code);
                                } else {
                                    location.href = 'tenoxen.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 5) {
                                if (win.app > 0) {
                                    Page.appRanking('texasHoldem.html?code=' + Page.code);
                                } else {
                                    location.href = 'texasHoldem.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 6) {
                                if (win.app > 0) {
                                    Page.appRanking('threeOpens.html?code=' + Page.code);
                                } else {
                                    location.href = 'threeOpens.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 7) {
                                if (win.app > 0) {
                                    Page.appRanking('fillingPit.html?code=' + Page.code);
                                } else {
                                    location.href = 'fillingPit.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 8) {
                                if (win.app > 0) {
                                    Page.appRanking('bull6.html?code=' + Page.code);
                                } else {
                                    location.href = 'bull6.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 9) {
                                if (win.app > 0) {
                                    Page.appRanking('bull9.html?code=' + Page.code);
                                } else {
                                    location.href = 'bull9.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 10) {
                                if (win.app > 0) {
                                    Page.appRanking('twelveoxenV2.html?code=' + Page.code);
                                } else {
                                    location.href = 'twelveoxenV2.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 11) {
                                if (win.app > 0) {
                                    Page.appRanking('thirteenoxen.html?code=' + Page.code);
                                } else {
                                    location.href = 'thirteenoxen.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 12) {
                                if (win.app > 0) {
                                    Page.appRanking('threeOpens6.html?code=' + Page.code);
                                } else {
                                    location.href = 'threeOpens6.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 13) {
                                if (win.app > 0) {
                                    Page.appRanking('threeOpens9.html?code=' + Page.code);
                                } else {
                                    location.href = 'threeOpens9.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 14) {
                                if (win.app > 0) {
                                    Page.appRanking('pushBobbin.html?code=' + Page.code);
                                } else {
                                    location.href = 'pushBobbin.html?code=' + Page.code;
                                }
                            } else if (parseInt(d.info.room.game) === 15) {
                                if (win.app > 0) {
                                    Page.appRanking('fishPrawnCrab.html?code=' + Page.code);
                                } else {
                                    location.href = 'fishPrawnCrab.html?code=' + Page.code;
                                }
                            }
                        });
                        ...
                        if (Page.game === 1 || Page.game === 4 || Page.game === 8 || Page.game === 9 || Page.game === 10 || Page.game === 11) {
                            if (parseInt(d.info.room.type) === 1) {
                                zhuang_type = '明牌抢庄';
                            } else if (parseInt(d.info.room.type) === 2) {
                                zhuang_type = '通比牛牛';
                            } else if (parseInt(d.info.room.type) === 3) {
                                zhuang_type = '自由抢庄';
                            } else if (parseInt(d.info.room.type) === 4) {
                                zhuang_type = '牛牛上庄';
                            } else if (parseInt(d.info.room.type) === 5) {
                                zhuang_type = '固定庄家';
                            }
                            if (d.info.room.room_rule.card_rule == 1) {
                                card_rule = '牛牛×3 牛九×2 牛八×2';
                            } else if (d.info.room.room_rule.card_rule == 2) {
                                card_rule = '牛牛x4牛九x3牛八x2牛七x2';
                            }
                            var arr_patterns = d.info.room.room_rule.hand_patterns;
                            for (var n in arr_patterns) {
                                if (arr_patterns[n] == 1) {
                                    patterns_text += '五花牛(5倍)';
                                }
                                if (arr_patterns[n] == 2) {
                                    patterns_text += '炸弹牛(6倍)';
                                }
                                if (arr_patterns[n] == 3) {
                                    patterns_text += '五小牛(8倍)';
                                }
                            }
                            ...
                            var numberLimit = '',
                                ruleType = '';
                            if (parseInt(d.info.room.room_rule.upper_limit) === 0) {
                                numberLimit = '无';
                            } else if (parseInt(d.info.room.room_rule.upper_limit) > 0) {
                                numberLimit = d.info.room.room_rule.upper_limit;
                            }
                            if (parseInt(d.info.room.room_rule.chip_rule) === 1) {
                                ruleType = '2/4，4/8，8/16，10/20';
                            } else if (parseInt(d.info.room.room_rule.chip_rule) === 2) {
                                ruleType = '2/4，5/10，10/20，20/40';
                            }
                            ...
                            var playType = '';
                            if (parseInt(d.info.room.room_rule.play_type) === 1) {
                                playType = '经典';
                            }
                            ...
                            var mang = '',
                                qianzhu = '';
                            if (parseInt(d.info.room.room_rule.end_points) === 1) {
                                mang = '1/2';
                            } else if (parseInt(d.info.room.room_rule.end_points) === 2) {
                                mang = '2/4';
                            }
                            if (parseInt(d.info.room.room_rule.end_points_rule) === 0) {
                                qianzhu = '无';
                            } else if (parseInt(d.info.room.room_rule.end_points_rule) === 1) {
                                qianzhu = '1倍小盲';
                            } else if (parseInt(d.info.room.room_rule.end_points_rule) === 2) {
                                qianzhu = '2倍小盲';
                            }
                            ...
                            Page.listItem(d);
                            Page.detailedItem();
                        } else if (Page.game === 6 || Page.game === 12 || Page.game === 13) {
                            if (parseInt(d.info.room.type) === 1) {
                                zhuang_type = '抢庄模式';
                            } else if (parseInt(d.info.room.type) === 2) {
                                zhuang_type = '通比模式';
                            ...
                            if (d.info.room.room_rule.card_rule == 1) {} else if (d.info.room.room_rule.card_rule == 2) {
                                card_rule = '暴玖';
                            }
                            $('<div>').html(d.info.room.match_count + '局' + d.info.room.need_cards + '房卡 底注' + d.info.room.room_rule.end_points + '分 ' + zhuang_type + ' ' + card_rule).appendTo('.detailed .game-rules');
                            Page.listItem(d);
                            ...
                            var play_type = '',
                                game_mode = '';
                            for (var ty in d.info.room.room_rule.play_type) {
                                if (parseInt(d.info.room.room_rule.play_type[ty]) === 1) {
                                    play_type += '带王 ';
                                } else if (parseInt(d.info.room.room_rule.play_type[ty]) === 2) {
                                    play_type += '王中炮 ';
                                }
                            }
                            if (parseInt(d.info.room.room_rule.games_mode) === 1) {
                                game_mode = '半坑(满5人10起)';
                            } else if (parseInt(d.info.room.room_rule.games_mode) === 2) {
                                game_mode = '半坑(满5人9起)';
                            } else if (parseInt(d.info.room.room_rule.games_mode) === 3) {
                                game_mode = '半坑(满4人J起)';
                            } else if (parseInt(d.info.room.room_rule.games_mode) === 4) {
                                game_mode = '全坑(2-A)';
                            }
                            if (parseInt(d.info.room.room_rule.sorce_type) == 1) {
                                var sorce_type = '烂锅翻倍';
                            } else {
                                var sorce_type = '';
                            }
                            $('<div>').html(d.info.room.match_count + '局' + d.info.room.need_cards + '房卡 底注' + d.info.room.room_rule.end_points + '分 玩法:' + game_mode + ' ' + sorce_type + ' 喜分:' + d.info.room.room_rule.happy_points).appendTo('.detailed .game-rules');
                            $('<div>').html('其他:' + play_type).appendTo('.detailed .game-rules');
                            Page.listItem(d);
                            Page.detailedItem();
                        } else if (Page.game === 14) {
                            if (parseInt(d.info.room.type) === 1) {
                                zhuang_type = '自由抢庄 ';
                                $('<div>').html(d.info.room.match_count + '局' + d.info.room.need_cards + '房卡 ' + zhuang_type + ' ' + (d.info.room.room_rule.chip_type == 1 ? '筹码:' + d.info.room.room_rule.chip.join(',') : '') + ' 下注上限：' + d.info.room.room_rule.max_point).appendTo('.detailed .game-rules');
                            } else if (parseInt(d.info.room.type) === 2) {
                                zhuang_type = '超级庄家 ';
                                $('<div>').html(d.info.room.match_count + '局' + d.info.room.need_cards + '房卡 ' + zhuang_type + ' ' + '上庄:' + d.info.room.room_rule.zhuang_value + ' 下注上限：' + d.info.room.room_rule.max_point).appendTo('.detailed .game-rules');
                            }
                            Page.listItem(d);
                            Page.detailedItem();
                        } else if (Page.game === 15) {
                            if (parseInt(d.info.room.type) === 1) {
                                zhuang_type = '超级庄家 ';
                            }
                            $('<div>').html(d.info.room.match_count + '局' + d.info.room.need_cards + '房卡 ' + zhuang_type + ' 最高下注:' + d.info.room.room_rule.chip_value + ' 庄家上限:' + d.info.room.room_rule.zhuang_value).appendTo('.detailed .game-rules');
                            Page.listItem(d);
                            Page.detailedItem();
                        }
                    } else {
                        if (d.info == -1) {
                            $('.game-rules').html('你没加入该游戏');
                        }
                    }
                }, "json");
        }
    ...
    listItem: function(d) {
        ...
        for (var i in d.info.matchs) {
            var minNum = d.info.matchs[i].match_num;
            var code = '<div class="detailed-item" data-item="' + d.info.matchs[i].match + '">';
            code += '   <div class="item-top">';
            if (Page.game === 7) {
                minNum = parseInt(minNum) - parseInt(matchNum);
                if (parseInt(d.info.matchs[i].score) === 0) {
                    matchNum++;
                    code += '   <div class="innings "><span class="innings-text">局数：</span><span class="innings-number">' + minNum + '/' + d.info.room.match_count + '</span> <span class="languo-text">烂锅底</span></div>';
                } else {
                    code += '   <div class="innings"><span class="innings-text">局数：</span><span class="innings-number">' + minNum + '/' + d.info.room.match_count + '</span></div>';
                }
            } else {
                code += '   <div class="innings"><span class="innings-text">局数：</span><span class="innings-number">' + minNum + '/' + d.info.room.match_count + '</span></div>';
            }
            if (parseInt(d.info.matchs[i].score) >= 0) {
                code += '   <div class="win-lost-score">';
                code += '   <span class="win-lost">积分</span>';
                code += '   <span class="score">' + parseInt(d.info.matchs[i].score) + '</span>';
            } else {
                code += '   <div class="win-lost-score lost">';
                code += '   <span class="win-lost">积分</span>';
                code += '   <span class="score">' + parseInt(d.info.matchs[i].score) + '</span>';
            }
            code += '   </div>';
    ...
    detailedItem: function() {
        $('.detailed-item').click(function() {
            ...
            if ($(this).children('.item-info').children().length > 0) {
                ...
                $.get('/portal/dasheng/matchrecord', {
                        id: Page.code,
                        match: match
                    },
                    function(d) {
                        ...
                        if (parseInt(d.status) === 1) {
                            ...
                            if (Page.game === 1 || Page.game === 4 || Page.game === 6 || Page.game === 8 || Page.game === 9 || Page.game === 10 || Page.game === 11 || Page.game === 12 || Page.game === 13) {
                            ...
                            for (var j in d.info.player) {
                                ...
                                codeItem += '<div class="user-path"><img src="' + d.info.player[j].path + '" >';
                                if (Page.game === 1 || Page.game === 4 || Page.game === 6 || Page.game === 8 || Page.game === 9 || Page.game === 10 || Page.game === 11 || Page.game === 12 || Page.game === 13) {
                                ...
                                } else if (Page.game === 14 || Page.game === 15) {
                                    if (parseInt(d.info.player[j].is_master) === 1) {
                                        codeItem += '<span>庄</span>';
                                    }
                                }
                                codeItem += '</div>';
                                ...
                                if (Page.game === 3) {
                                    ...
                                    codeItem += '<div class="">';
                                    var erbaCardInfo = d.info.player[j].card_info;
                                    for (var erba in erbaCardInfo) {
                                        codeItem += '<div class="erbagangCard" data-item="' + erba + '"></div>';
                                    }
                                } else if (Page.game === 15) {
                                    if (parseInt(d.info.player[j].no_join) === 1) {
                                        codeItem += '<div class="card-type">';
                                    } else {
                                        codeItem += '<div class="card-type fish-card-type">';
                                        if (parseInt(d.info.player[j].is_master) === 1) {
                                            codeItem += '<div class="">开骰：</div>';
                                        }
                                        for (var c in d.info.player[j].card) {
                                            codeItem += '<div class="fish-cardbox" data-item="' + c + '">';
                                            if (parseInt(d.info.player[j].is_master) === 1) {
                                                codeItem += '<div class="card" data-value="' + d.info.player[j].card[c] + '"></div>';
                                            } else {
                                                codeItem += '<div class="card" data-value="' + d.info.player[j].card[c][1] + '"></div>';
                                                codeItem += '<div class="card-number">' + d.info.player[j].card[c][0] + '</div>';
                                            }
                                            codeItem += '</div>';
                                        }
                                    }
                                        ...
                                        for (var c in d.info.player[j].card) {
                                            ...
                                            if (Page.game === 5) {
                                                ...
                                                if (parseInt(d.info.player[j].card[c][1]) === 15) {
                                                    if (parseInt(d.info.player[j].public) === 1 && parseInt(c) === 4) {
                                                        codeItem += '<span class="card" data-value="1" data-color="' + d.info.player[j].card[c][0] + '"><i class="card-jie"></i></span>';
                                                    } else {
                                                        codeItem += '<span class="card" data-value="1" data-color="' + d.info.player[j].card[c][0] + '"></span>';
                                                    }
                                                } else {
                                                    if (parseInt(d.info.player[j].public) === 1 && parseInt(c) === 4) {
                                                        codeItem += '<span class="card" data-value="' + d.info.player[j].card[c][1] + '" data-color="' + d.info.player[j].card[c][0] + '"><i class="card-jie"></i></span>';
                                                    } else {
                                                        codeItem += '<span class="card" data-value="' + d.info.player[j].card[c][1] + '" data-color="' + d.info.player[j].card[c][0] + '"></span>';
                                                    }
                                                }
                                ...
                                if (parseInt(d.info.player[j].no_join) === 1) {
                                    ...
                                    if (parseInt(d.info.player[j].value) >= 0) {
                                        codeItem += '<div class="list-info-score">' + d.info.player[j].value + '</div>';
                                    } else {
                                        codeItem += '<div class="list-info-score lost">' + d.info.player[j].value + '</div>';
                                    }
                                }
                                codeItem += '</div>';
                            }
                            ...
                            if (Page.game === 7) {
                                if (d.info.languo == 1) {
                                    codeItem += '<div class="game-languo"></div>';
                                }
                            }
                            $('.detailed-list .detailed-item[data-item="' + match + '"] .item-top').addClass('icon');
                            ...
                            if (Page.game === 14) {
                                for (var jjj in d.info.player) {
                                    var erbaCardInfo = d.info.player[jjj].card_info;
                                    for (var erba in erbaCardInfo) {
                                        var erbaNumber = erbaCardInfo[erba].card_code;
                                        if (erbaNumber > 10 && erbaNumber < 12) {
                                            Page.erbaCode = '对子';
                                        } else if (erbaNumber == 10) {
                                            Page.erbaCode = '二八杠';
                                        } else if (erbaNumber == 12) {
                                            Page.erbaCode = '对白板';
                                        } else if (erbaNumber == 0) {
                                            Page.erbaCode = '零点';
                                        } else if (erbaNumber == 1) {
                                            Page.erbaCode = '一点';
                                        } else if (erbaNumber == 1.5) {
                                            Page.erbaCode = '一点半';
                                        } else if (erbaNumber == 2) {
                                            Page.erbaCode = '两点';
                                        } else if (erbaNumber == 2.5) {
                                            Page.erbaCode = '两点半';
                                        } else if (erbaNumber == 3) {
                                            Page.erbaCode = '三点';
                                        } else if (erbaNumber == 3.5) {
                                            Page.erbaCode = '三点半';
                                        } else if (erbaNumber == 4) {
                                            Page.erbaCode = '四点';
                                        } else if (erbaNumber == 4.5) {
                                            Page.erbaCode = '四点半';
                                        } else if (erbaNumber == 5) {
                                            Page.erbaCode = '五点';
                                        } else if (erbaNumber == 5.5) {
                                            Page.erbaCode = '五点半';
                                        } else if (erbaNumber == 6) {
                                            Page.erbaCode = '六点';
                                        } else if (erbaNumber == 6.5) {
                                            Page.erbaCode = '六点半';
                                        } else if (erbaNumber == 7) {
                                            Page.erbaCode = '七点';
                                        } else if (erbaNumber == 7.5) {
                                            Page.erbaCode = '七点半';
                                        } else if (erbaNumber == 8) {
                                            Page.erbaCode = '八点';
                                        } else if (erbaNumber == 8.5) {
                                            Page.erbaCode = '八点半';
                                        } else if (erbaNumber == 9) {
                                            Page.erbaCode = '九点';
                                        } else if (erbaNumber == 9.5) {
                                            Page.erbaCode = '九点半';
                                        } else {
                                            Page.erbaCode = '';
                                        }
                                        var erbaItem = '';
                                        erbaItem += '<div class="erbaCardName">' + Page.erbaCode + '</div>';
                                        for (var erbaCard in erbaCardInfo[erba].cards) {
                                            erbaItem += '<div class="erbaCard" data-value="' + erbaCardInfo[erba].cards[erbaCard][1] + '"></div>';
                                        }
                                        if (erbaCardInfo[erba].ante.length > 0) {
                                            for (var erbaxiafen in erbaCardInfo[erba].ante) {
                                                erbaItem += '<div class="erbaxiafen">' + erbaCardInfo[erba].ante[erbaxiafen].value + '</div>';
                                            }
                                        } else {
                                            erbaItem += '<div class="erbaxiafen"> </div>';
                                        }
                                        $(erbaItem).appendTo('.detailed-item[data-item="' + match + '"] .info-list-item[data-item="' + jjj + '"] .erbagangCard[data-item="' + erba + '"]');
                                    }
                                }
                            }
                        }
    ...
    appRanking: function(test) {
        app_command('appRanking', {
            'name': test
        });
    }
};