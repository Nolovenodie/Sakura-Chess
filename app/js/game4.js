...
function showtanpai(){
    ...
    var msgxx={};
    msgxx.index=index;
    msgxx.img='/img/dx/'+allcardxx['niu'][index]+'.png';
...
function showothertanpai(data){
    if(data==index){
        ...
        var msgxx={};
        msgxx.index=data;
        msgxx.img='/img/dx/'+allcardxx['niu'][data]+'.png';
        showmemberBull(msgxx);
...
function adduser(data){
    ...
    var html='    <div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html+='<div  style="background: url(\'/app/img/bull10/game-leave.png\') no-repeat center top rgba(0,0,0,0.3);background-size: 90%;z-index: 888;position: absolute;width:50px;height:50px; border-radius:8px;'+onlinezt+'" ></div>'
     html+='<img style="z-index:82;border-radius:10px"src="'+data.user.img+'" class="avatar" />'
     html+='<img src="/app/img/bull9/playerWin.png" class="banker" style="display: none;" /> '
     html+='<div class="bottom jiurenniuniu-bottom">'
     html+='<div class="bname jiurenniuniu-bname"style="font-size:12px;">'+decode64(data.user.nickname)+'</div>'
    html+='<div class="bscore jiurenniuniu-bname"style="color:#ff9000;font-size:15px;">'+data.user.dqjf+'</div></div> '
    html+='<img id="banker213612" src="/app/img/bull9/bull_banker_bg.png" class="background jiurenniuniu-background" /> '
     ...
     html+='<img id="bankerAnimate1'+indexuser+'" src="/app/img/bull9/bull_banker_animate.png" class="jiurenniuniu-background2" /><div class="isReady" style="display:none;color:#f2eb1f;font-size:24px;font-weight:bold;width:50px;">准备</div></div>';
     $('#member').append(html);
     if(data.user.zt==1){
...
function qbankshow(data){
    ...
    if(data.zt){
        if(data.type==4){
            ...
            html+='<img class="jiurenniuniu-qiangzhuangs-img" src="/img/sg/bull_text_'+bankwz+'.png">'
            ...
            html+='<div id="jiurenniuniu-qiangzhuangs" class="jiurenniuniu-qiangzhuangs" style="display: block;">'
            html+='<img class="jiurenniuniu-qiangzhuangs-img" src="/img/sg/bull_text_'+bankwz+'.png"></div>'
        }
        mp3xx='qiangzhuang';
    }
    else{
        html+='<div id="jiurenniuniu-qiangzhuangs" class="jiurenniuniu-qiangzhuangs" style="display: block;">';
        html+='<img class="jiurenniuniu-qiangzhuangs-img" src="/img/sg/bull_text_not'+bankwz+'.png"></div>';
        mp3xx='buqiang';
    }
...
function qbankshowother(data){
    ...
    if(data.zt){
        if(data.type==4){
            ...
            msgxx.img='/img/sg/bull_text_'+bankwz+'.png';
        ...
        msgxx.img='/img/sg/bull_text_not'+bankwz+'.png';
        showmemberRobText(msgxx);
        mp3xx='buqiang';
    }
    mp3play(mp3xx);
...
function createRanking(data, func) {
    ...
    var width = 750;
    var height = 1216;
   var pics = ['/img/sgbj.jpg', '/app/img/bull10/people_bg.png', '/app/img/bull10/ranking_icon.png'];
    if (users.length > 6) {
...
function operationButton(data){
    ...
    if(data=='2'){
        ...
        html+='             <img src="/img/bs74.png"  class="operationButton-gg"  /> '
    ...
    if(data=='3'){
        html+='<div class="operationButton-3-zt" id="jiurenqz" style="display: inline-block; margin: 0 0;" onclick="qbank(1,2)">'
        html+='                      <img class="operationButton-3" style="width:65px;"src="/img/cz74.png">'
        html+='                      <div class="operationButton-3-ts" >'
        html+='                       <!--抢庄-->'
        html+='                      </div>'
        html+='                     </div>'
        html+='                     <div class="operationButton-4-zt" id="jiurenbqz" style="display: inline-block; margin: 0 0;" onclick="qbank(0,2)">'
        html+='                      <img class="operationButton-gg" style="width:65px;"src="/img/bc74.png">' 
    ...
    if(data=='4'){
        html+='<div class="divCoin divCoin1" style="display: inline-block;margin: 0 0;'
        ...
        html+='              </div>'
        html+='             </div> '
        html+='             <div class="divCoin divCoin2" style="display: inline-block;margin: 0 0;'
        ...
        html+='              </div>'
        html+='             </div> '
        html+='             <div class="divCoin divCoin3" style="display: inline-block;margin: 0 0;'
        ...
        html+='              </div>'
        html+='             </div>' 
        html+='             <div class="divCoin divCoin4" style="display: inline-block;margin: 0 0;'
    ...
    if(data=='5'){
        html+='<div class="gongg" style="display: block;color:#fdd900;font-size:20px;z-index:888;height:55px;top:-10px">等待闲家下注</div>';
    }
    if(data=='6'){
        html+='<div class="gongg" style="display: block;color:#fdd900;font-size:20px;z-index:888;height:55px;top:-10px">点击牌面翻牌</div>';
    }
    if(data=='7'){
        html+='<div class="operationButton-1-zt" id="jiurenbqz" style="display: block;" onclick="tanpaime();">';

        html+='<div class="operationButton-gg" style="background:url(/img/zbbj74.png)no-repeat;background-size:100% 100%;height:45px;width:110px;color:#b23f20;font-size:22px; line-height:45px; ">';
        html+='摊牌';
        html+='</div>';
        html+='</div>';
    }
    if(data=='8'){
        html+='<div id="zb" onClick="zhunbei()"class="operationButton-1-zt"style="background:url(/img/zbbj74.png)no-repeat;background-size:100% 100%;height:45px;width:110px;color:#b23f20;font-size:22px; line-height:45px; ">准备</div>';
    }

    if(data=='9'){
        html+='<div class="operationButton-2-zt"><div id="zbs"  style="display:block;color:#f2eb1f;font-size:24px;font-weight:bold;width:50px;">准备</div></div>';
    }
...
function divRobBankerText(data){
    var html='';
    if(data=='0'){
        html+='<p class="liurenniuniu-ziti"style="color:#fdd900;font-size:20px;">准备开始</p>';
    }
    if(data=='1'){
        html+='<p class="liurenniuniu-ziti"style="color:#fdd900;font-size:20px;">上庄</p>';
    }
    if(data=='2'){
        html+='<p class="liurenniuniu-ziti"style="color:#fdd900;font-size:20px;">抢庄</p>';
    }
    if(data=='3'){
        html+='<p class="liurenniuniu-ziti"style="color:#fdd900;font-size:20px;">闲家下注</p>';
    }
    if(data=='4'){
        html+='<p class="liurenniuniu-ziti"style="color:#fdd900;font-size:20px;">等待摊牌</p>';
    }
    if(data=='5'){
        html+='<p class="liurenniuniu-ziti"style="color:#fdd900;font-size:20px;">等待结束</p>';
    }
