...
function showtanpai(){
    ...
    var msgxx={};
    msgxx.index=index;
    msgxx.img='/img/'+allcardxx['niu'][index]+'.png';
...
function showothertanpai(data){
    if(data==index){
        ...
        var msgxx={};
        msgxx.index=data;
        msgxx.img='/img/'+allcardxx['niu'][data]+'.png';
        showmemberBull(msgxx);
...
function roomxx(data){
    var move = {
        2  : ["right", "112.5vh", "14.5vh", "16.5vh", "18.5vh", "20.5vh"],
        3  : ["right", "112.5vh", "14.5vh", "16.5vh", "18.5vh", "20.5vh"],
        4  : ["right", "112.5vh", "14.5vh", "16.5vh", "18.5vh", "20.5vh"],
        5  : ["right", "112.5vh", "14.5vh", "16.5vh", "18.5vh", "20.5vh"],
    ...
    if(allcardxx['niu'][data.user.index] > 0) {
        move = {
            2  : ["right", "112.5vh", "14.5vh", "19.5vh", "21.5vh", "23.5vh"],
            3  : ["right", "112.5vh", "14.5vh", "19.5vh", "21.5vh", "23.5vh"],
            4  : ["right", "112.5vh", "14.5vh", "19.5vh", "21.5vh", "23.5vh"],
            5  : ["right", "112.5vh", "14.5vh", "19.5vh", "21.5vh", "23.5vh"],
            6  : ["left",  "36vw", "40vw", "44vw", "52vw", "56vw"],
            7  : ["left",  "12.5vh", "14.5vh", "16.5vh", "21.5vh", "23.5vh"],
            8  : ["left",  "12.5vh", "14.5vh", "16.5vh", "21.5vh", "23.5vh"],
            9  : ["left",  "12.5vh", "14.5vh", "16.5vh", "21.5vh", "23.5vh"],
            10 : ["left",  "12.5vh", "14.5vh", "16.5vh", "21.5vh", "23.5vh"]
        };
    }
}
function adduser(data){
    ...
    var html='    <div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html+='<div style="background: url(\'/app/img/bull10/game-leave.png\') no-repeat center top rgba(0,0,0,0.3);background-size: 90%;z-index: 888;position: absolute;width: 100%;height: 100%;'+onlinezt+'" class="onlinezt"></div>'
     html+='<img src="'+data.user.img+'" class="avatar" />'
     html+='<div class="banker flash" style="display: none;"></div>'
     html+='<div class="bottom jiurenniuniu-bottom"style="height:32px;">'
     html+='<div class="bname jiurenniuniu-bname"style="color:#fff;font-size:12px;">'+decode64(data.user.nickname)+'</div>'
    html+='<div class="bscore jiurenniuniu-bname"style="color:#ff9000;font-size:15px;height:72px;">'+data.user.dqjf+'</div></div> '
    html+='<img id="banker213612" src="/app/img/bull9/bull_banker_bg.png" class="background jiurenniuniu-background" /> '
     html+='<img src="/app/img/bull10/zhuang.png" class="background jiurenniuniu-background1" />'
...
function jibiover2(){
    ...
    $('#memberScoreText1 div').each(function(){
        ...
        if(dqjf-lsjf>0){
            $(this).html('<label class="jiurenniuniu-memberScoreText2"  style="display: block;font-size:22px;">+'+(dqjf-lsjf)+'</label>');
        }
        else{
            $(this).html('<label class="jiurenniuniu-memberScoreText1"  style="display: block;font-size:22px;">'+(dqjf-lsjf)+'</label>');
        }
        var $this = $(this);
...
function initroom(){
    ...
    $("img.avatar").each(function(i, item) {
        ...
        if(src.search("\/index\.php") < 0 && !window.userimg[src]) {
            ...
            image.src = "/index.php/Portal/thumb/index?url="+encodeURIComponent(src);
...
function operationButton(data){
    ...
    if(data=='2'){
        ...
        html+='             <img src="/app/img/bull10/niuniu-zhuang.png"  class="operationButton-gg"  /> '
        ...
        html+='              <img src="/app/img/bull10/niuniu-zhuang1.png"  class="operationButton-gg"  /> '
        html+='              <div  class="operationButton-gg3" style="font-size:18px;font-weight:bold"  >'
        html+='               不抢'
        html+='              </div>'
        html+='             </div> '
    ...
    if(data=='6'){
       html+='<div class="operationButton-1-zt" id="jiurenbqz" style="display: inline-block;" onclick="tanpaime();">';
        html+='<img class="operationButton-gg" src="/app/img/bull10/niuniu-prepare.png"  /> ';
    ...
    if(data=='8'){
        ...
        html+='<div class="operationButton-1-zt">' +
            '<img class="operationButton-1" id="zb" src="/app/img/bull10/niuniu-prepare.png"/>' +
            '<div class="operationButton-gg1"  style="width: 100%;font-size:23px;" onClick="zhunbei()">准备</div>'+
            '</div>';
    }
...
function Gold(source, target) {
    ...
    var img = new Image();
    img.src = "/app/img/bull10/gold.png";
    img.onload = function() {
        move();
    }
    function move() {
