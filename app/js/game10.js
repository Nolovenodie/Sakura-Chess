...
function showtanpai(){
    ...
    var msgxx={};
    msgxx.index=index;
    msgxx.img='/img/nn/'+allcardxx['niu'][index]+'.png';
...
function showothertanpai(data){
    if(data==index){
        ...
        var msgxx={};
        msgxx.index=data;
        msgxx.img='/img/nn/'+allcardxx['niu'][data]+'.png';
        showmemberBull(msgxx);
...
function adduser(data){
    ...
    html+='<div class="zmmyctime"></div>'
     html+='<div style="background: url(\'/app/img/bull10/game-leave.png\') no-repeat center top rgba(0,0,0,0.9);z-index: 8888;background-size: 90%;position: absolute;width: 6vh;height: 6vh;'+onlinezt+'"  class="onlinezt"></div>'
     html+='<img src="'+data.user.img+'" style="z-index:999;"class="avatar" />'
     html+='<img src="/app/img/bull9/playerWin.png" class="banker" style="display: none;" /> '
     html+='<div class="bottom shiren-bottom">'
     html+='<div style="font-size:12px;"class="bname shiren-bname">'+decode64(data.user.nickname)+'</div>'
    html+='<div style="background-color: rgba(0, 0, 0, 0.8); border-radius: 5px; overflow: hidden;"class="bscore shiren-bname">'+data.user.dqjf+'</div></div> '
    html+='<img id="banker213612" src="/app/img/bull9/bull_banker_bg.png" class="background shiren-background" /> '
     ...
     html+='<img id="bankerAnimate1'+indexuser+'" src="/app/img/bull9/bull_banker_animate.png" class="shiren-background2" /><div class="isReady" style="display:none;color:#f2eb1f;font-size:24px;font-weight:bold;width:50px;">准备</div></div>';
     $('#member').append(html);
     if(data.user.zt==1){
...
function qbankshow(data){
    ...
    if(data.zt){
        if(data.type==4){
            html+='<div id="jiurenniuniu-qiangzhuangs" class="jiurenniuniu-qiangzhuangs" style="display: block;margin-left:-25%;margin-top:-1px;">'
            html+='<img class="jiurenniuniu-qiangzhuangs-img" src="/app/img/bull9/bull_text_'+bankwz+'.png">'
            html+='</div><div id="jiurenniuniu-qiangzhuangs" class="jiurenniuniu-qiangzhuangs" style="display: block;width: 17px;margin-left:-15%;margin-top:-1px;">'
...
function createRanking(data, func) {
    ...
    var width = 750;
    var height = 1216;
   var pics = ['/app/img/bull10/bj.jpg', '/app/img/bull10/people_bg.png', '/app/img/bull10/ranking_icon.png'];
    if (users.length > 6) {
...
function operationButton(data){
    ...
    if(data=='1'){
        ...
        html+='                        <img style="height:35px;width:50px;"class="operationButton-3" src="/app/img/bull10/niuniu-zhuang.png">'
        html+='                        <div class="operationButton-3-ts"style="font-size:18px;font-weight:bold;"  >'
        html+='上庄'
        html+='                        </div>'
        html+='                       </div>'
        html+='                       <div class="operationButton-4-zt" id="jiurenbqz" style="display: inline-block; margin: 0 2%;" onclick="qbank(0,1)">'
        html+='                        <img style="height:35px;width:50px;"class="operationButton-gg" src="/app/img/bull10/niuniu-zhuang1.png"> '
        html+='                        <div class="operationButton-3-ts" style="font-size:18px;font-weight:bold;" >'
        html+='不上'
        html+='                        </div>'
        html+='                       </div>'
    ...
    if(data=='2'){
        ...
        html+='             <img style="height:35px;width:50px;"src="/app/img/bull10/niuniu-zhuang.png"  class="operationButton-gg"  /> '
        html+='              <div class="operationButton-gg3"style="font-size:18px;font-weight:bold;" >'
        html+='               1倍'
        html+='             </div>'
        html+='             </div> '
        ...
        html+='              <img style="height:35px;width:50px;"src="/app/img/bull10/niuniu-zhuang1.png"  class="operationButton-gg"  /> '
        html+='              <div  class="operationButton-gg3" style="font-size:18px;font-weight:bold;"  >'
        html+='               不抢'
        html+='              </div>'
        html+='             </div> '
    ...
    if(data=='3'){
        ...
        html+='                      <img style="height:35px;width:50px;"class="operationButton-gg" src="/app/img/bull10/niuniu-zhuang1.png">'
        html+='                      <div class="operationButton-gg1" style="font-size:18px;font-weight:bold;" >'
        html+='                       不抢'
        html+='                      </div>'
        html+='                     </div>';
    }
    ...
    if(data=='6'){
       html+='<div class="operationButton-1-zt" id="jiurenbqz" style="display: inline-block;margin-top:-10px;" onclick="tanpaime();">';
        html+='<img style="height:45px;width:110px;"class="operationButton-gg" src="/app/img/bull10/niuniu-prepare.png"  /> ';
        html+='<div   class="operationButton-gg1"  style="width: 100%;font-size:24px;margin-left:5px;font-weight:bold;top:5px">';
        html+='摊牌';
        html+='</div>';
        html+='</div>';
    }
    ...
    if(data=='8'){
        html+='<div class="operationButton-1-zt"><img class="operationButton-1" id="zb" src="/img/readyButton1.png" style="height:45px;width:110px;"onClick="zhunbei()"></div>';
    }
