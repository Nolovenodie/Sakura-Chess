...
function showtanpai(){
    ...
    var msgxx={};
    msgxx.index=index;
    msgxx.img='http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/pai/point/win'+allcardxx['allniu'][index]+'.png';
...
function showothertanpai(data){
    if(data==index){
        ...
        var msgxx={};
        msgxx.index=data;
        msgxx.img='http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/pai/point/win'+allcardxx['allniu'][data]+'.png';
        showmemberBull(msgxx);
...
function adduser(data){
    ...
    var html='    <div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html+='<div style="background: url(\'http://xj218.hbyueyou.com/static/img/bull10/wif.png\') no-repeat center top rgba(0,0,0,0.3);background-size: 150%;z-index: 888;position: absolute;width: 100%;height: 100%;'+onlinezt+'" class="onlinezt"></div>'
    ...
    html+='<img id="banker213612" src="http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/bull_banker_bg.png" class="background jiurenniuniu-background" /> '
     html+='<img src="http://xj218.hbyueyou.com/static/img/bull10/zhuang.png" class="background jiurenniuniu-background1" />'
     html+='<div id="bankerAnimate'+indexuser+'" class="jiurenniuniu-background2 flash" style="border-radius:0;"></div>'
     html+='<div id="bankerAnimate1'+indexuser+'" class="jiurenniuniu-background2 flash" style="border-radius:0;"></div><div class="isReady" style="display:none"><img style="width: 10vw;" src="http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/readytxt.png"/></div></div>';
     $('#member').append(html);
...
function showmemberRobText2(data){
    ...
    var html='<div class="memberFreeRobText'+indexuser+'" style="display: block;" >抢庄×'+data['beishu']+'</div>';
...
function jibi(data){
    ...
    for(var i=0;i<11;i++){
        var $html=$('<div class="memberCoin member'+win+lose+'"><img src="http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/goldcoin.png" class="jiurenniuniu-memberCoin" /></div>');
        $('#jinbi').append($html);
    ...
    $("img.avatar").each(function(i, item) {
        ...
        if(src.search("\/index\.php") < 0 && !window.userimg[src]) {
            ...
            image.onerror = function (ev) {
                image.src = "http://xj218.hbyueyou.com/static/img/bull10/default_head.png";
            }
...
function showxian(data){
    ...
    msgxx.img='http://xj218.hbyueyou.com/static/img/X-'+data.zt+'.png';
...
function qbankshow(data){
    ...
    if(data.zt){
        if(data.type==4){
            ...
            if(bankwz != 'rob') {
                html+='<img class="jiurenniuniu-qiangzhuangs-img" src="http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/pai/A2.png/static/img/bull10/bull_text_'+bankwz+'.png">';
            }
            html+='</div><div id="jiurenniuniu-qiangzhuangs" class="jiurenniuniu-qiangzhuangs" style="display: block;height: 4.16vh;">'
            html+='抢庄×'+data.zt;
            html+='</div>'
        }
        else{
            html+='<div id="jiurenniuniu-qiangzhuangs" class="jiurenniuniu-qiangzhuangs" style="display: block;">'
            if(bankwz != 'rob') {
                html += '<img class="jiurenniuniu-qiangzhuangs-img" src="http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/pai/A2.png/static/img/bull10/bull_text_' + bankwz + '.png"></div>'
            }
        }
...
function qbankshowother(data){
    ...
    if(data.zt){
        if(data.type==4){
            ...
            msgxx.img='http://xj218.hbyueyou.com/static/img/bull10/bull_text_'+bankwz+'.png';
            if(bankwz != 'rob') {
        ...
        msgxx.img='http://xj218.hbyueyou.com/static/img/bull10/bull_text_not'+bankwz+'.png';
        showmemberRobText(msgxx);
...
function overroom(data){
    ...
    var img1=new Image()
    var img2=new Image()
    img.src="http://xj218.hbyueyou.com/static/img/bull10/ranking_4_bg.jpg";
    img1.src="http://xj218.hbyueyou.com/static/dyj.png";
    //img2.src="bg.png";
    var sj=data;
...
function operationButton(data){
    ...
    if(data=='1'){
        ...
        html+='                        <img class="operationButton-3" src="http://xj218.hbyueyou.com/static/img/bull10/niuniu-zhuang.png">'
        ...
        html+='                        <img class="operationButton-gg" src="http://xj218.hbyueyou.com/static/img/bull10/niuniu-zhuang1.png"> '
        html+='                        <div class="operationButton-3-ts" >'
        html+='不上'
        html+='                        </div>'
        html+='                       </div>'
    ...
    if(data=='2'){
        ...
        html+='             <img src="http://xj218.hbyueyou.com/static/img/bull10/niuniu-zhuang.png"  class="operationButton-gg"  /> '
        ...
        html+='              <img src="http://xj218.hbyueyou.com/static/img/bull10/niuniu-zhuang1.png"  class="operationButton-gg"  /> '
        html+='              <div  class="operationButton-gg3"  >'
        html+='               不 抢'
        html+='              </div>'
        html+='             </div> '
    ...
    if(data=='7'){
        ...
        html+='<img class="operationButton-gg" src="http://xj218.hbyueyou.com/static/img/bull10/niuniu-prepare.png"  /> ';
    ...
    if(data=='8'){
        ...
        html+='<div class="operationButton-1-zt">' +
            '<img class="operationButton-1" id="zb" src="http://xj218.hbyueyou.com/static/img/bull10/niuniu-prepare.png"/>' +
            '<div class="operationButton-gg1"  style="width: 100%;" onClick="zhunbei()">准 备</div>'+
            '</div>';
    }

    if(data=='9'){
        html+='<div class="operationButton-2-zt"><img style="width: 15vw;" src="http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/readytxt.png"/></div>';
    }
...
function Gold(source, target) {
    ...
    var img = new Image();
    img.src = "http://xj218.hbyueyou.com/static/img/bull10/gold.png";
    img.onload = function() {
        move();
    }
    function move() {
...
function createRanking(data, func) {
    ...
    var width = 750;
    var height = 1216;
    var pics = ['http://xj218.hbyueyou.com/static/img/bull10/ranking_' + game_id + '_bg.jpg', 'http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/userbg.png', 'http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/winboss.png'];
    if (users.length > 16) {
        pics.push('http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/pai/A2.png/static/img/bull10/people_bg2.jpg');
        pics.push('http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/pai/A2.png/static/img/bull10/people_bg3.jpg');
    ...
    for (var i in pics) {
        if(!window.userimg[pics[i]]) {
            ...
            img.onerror = function () {
                this.src = "http://xj218.hbyueyou.com/themes/game/Public/zhongyi/img/pai/A2.png/static/img/bull10/default_head.png";
            };
            img.src = pics[i];
        } else {
